        ...
        <div class="container">
            ...
            <form action="{{ route('eventlist.update', $event->id) }}" method="POST"> 
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="total_seat_columns" name="total_seat_columns" min="0" max="100" oninput="validateInput(this)" value="{{ $event->total_seat_columns }}">
                </div>
                <div>
                ...
                <div>
                    <div id="seatClasses" value="{{ $seatclassstring }}">
                        ...
                        <input type="number" class="form-label form-number" name="seatclass[0][total_seat_rows]" placeholder="Total Seat Rows" oninput="validateInput(this)" value="{{ $seatclass[0]['total_seat_rows']}}">
        ...
        function autoAddSeatClass() {
            for (let i = 1; i < seatClass.length; i++) {
                ...
                seatClassDiv.innerHTML = `
                    ...
                    <input type="number" class="form-label form-number" name="seatclass[${index}][total_seat_rows]" placeholder="Total Seat Rows" oninput="validateInput(this)" value="${seatClass[index]['total_seat_rows']}">
